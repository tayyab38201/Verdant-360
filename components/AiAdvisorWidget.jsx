...
import { X, Send, Sparkles, Bot, User, AlertTriangle, TreePine, Route, Droplet, MapPin, FileDown, Building2 } from 'lucide-react';
          ...
          >
            <div className={`h-full flex flex-col shadow-2xl border-l ${
              ...
              <div className={`flex items-center justify-between p-4 border-b ${darkMode ? 'border-slate-700' : 'border-emerald-100/60'}`}>
                ...
                <button onClick={() => setOpen(false)} className={`w-9 h-9 rounded-lg flex items-center justify-center ${darkMode ? 'bg-slate-800' : 'bg-slate-100'}`}>
